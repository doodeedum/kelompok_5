...
//
//  ASSET 3 — IKON mata pelajaran (sidebar lingkaran + header + kartu sidebar kanan)
//  Ukuran tampil : 54×54 px (sidebar lingkaran), 44×44 px (title bar), 69×69 px (item sidebar kanan)
//  Format        : PNG transparan
//  Letakkan file di: ASSET/bahasa_indonesia.png
$asset_icon = 'ASSET/bahasa_indonesia.png';
//
