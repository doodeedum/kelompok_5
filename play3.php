...
<head>
    ...
    <style>
        /* ==============================
           CSS VARIABLES & RESET
           Aksen Level 3: Kuning Emas Gelap #C8B800
           Timer & Jawab pakai warna ini
           (Level 1: Hijau #C5DE96 | Level 2: Biru #78D3F4)
        ============================== */
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }

        :root {
            --yellow-btn:   #C8B800;   /* ← Kuning emas gelap Level 3 (timer + tombol Jawab) */
            --yellow-light: #F2F478;   /* ← Kuning muda untuk hover & selected */
            --white:        #ffffff;
            --black:        #1a1a1a;
            --radius:       30px;
        ...
        ║  Ukuran  : 171 × 153 px (tampil 52px tinggi di header)   ║
        ...
        */
        ...
        @keyframes scoreBump {
            0%   { transform: scale(1); }
            40%  { transform: scale(1.4); color: #7a6e00; }
            100% { transform: scale(1); }
        }

        /* ==============================
           TIMER — KUNING EMAS GELAP sesuai Level 3
        ============================== */
        .timer-wrap {
            position: absolute;
            top: 24px;
        ...
        .timer-circle {
            width: 63px;
            height: 63px;
            /* ← Kuning emas gelap #C8B800 sesuai Level 3 */
            ...
            font-size: 22px;
            font-weight: 700;
            /* Teks putih agar kontras di atas warna gelap */
            color: var(--white);
            font-family: 'Inter', sans-serif;
        ...
        .progress-fill {
            height: 100%;
            /* Progress bar kuning emas gelap sesuai Level 3 */
            background: var(--yellow-btn);
            border-radius: 10px;
        ...
        .option-key-circle:hover { background: var(--yellow-light); transform: scale(1.06); }
        ...
        .option-box:hover { background: var(--yellow-light); transform: translateX(4px); }

        /* Terpilih — kuning emas gelap */
        .option-selected .option-key-circle { background: var(--yellow-btn); border-color: #7a6e00; color: var(--white); }
        .option-selected .option-box        { background: var(--yellow-light); border-color: #7a6e00; }
        ...
        /* ==============================
           TOMBOL JAWAB — KUNING EMAS GELAP sesuai Level 3
        ============================== */
        .submit-wrap {
            display: flex;
        ...
        .btn-jawab {
            ...
            font-size: 36px;
            font-weight: 400;
            /* Teks putih agar terbaca di atas kuning gelap */
            color: var(--white);
            cursor: pointer;
            transition: background 0.18s, transform 0.14s;
        }

        .btn-jawab:hover  { background: #a89a00; transform: translateY(-2px); }
...
<div class="quiz-header" style="position:relative;">
    ...
    <!-- Timer — lingkaran kuning emas gelap -->
