...
//
//  ASSET 3 — IKON mata pelajaran IT
//  Ukuran tampil : 54×54 px (sidebar lingkaran), 44×44 px (title bar), 69×69 px (item sidebar kanan)
//  Format        : PNG transparan
//  Letakkan file di: ASSET/it.png
$asset_icon = 'ASSET/it.png';
//
...
<head>
  ...
  <style>
    /* ═══════════════════════════════════════════
       CSS VARIABLES — Tema IT (Biru Teal)
       Berbeda dari Bahasa Indonesia (Pink #E84393)
       IT menggunakan warna biru-teal #0EA5E9 / #0284C7
    ═══════════════════════════════════════════ */
    :root {
      --aksen:       #0EA5E9;    /* sky blue — pengganti pink */
      --aksen-dark:  #0369A1;    /* dark sky blue */
      --bg-light:    #F0F9FF;    /* sky-50 */
      --bg-yellow:   #E0F2FE;    /* sky-100 — pengganti kuning */
      --bg-cream:    #E0F7FA;    /* cyan ringan */
      --bg-kartu:    #BAE6FD;    /* sky-200 — pengganti hijau muda */
      --black:       #000000;
      --white:       #FFFFFF;
      --nav-h:       90px;
      --sidebar-w:   322px;
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* ═══════════════════════════════════════════
       BODY — gradient biru terang → putih kekuningan
    ═══════════════════════════════════════════ */
    body {
      min-height: 100vh;
      font-family: 'Inter', sans-serif;
      background: linear-gradient(180deg, #FFFFFE 0%, #BAE6FD 50%, #E0F7FA 100%);
      position: relative;
      overflow-x: hidden;
    }
    ...
    /* ═══════════════════════════════════════════
       NAVBAR — sama seperti BI, warna aksen biru
    ═══════════════════════════════════════════ */
    nav {
      width: 100%;
      height: var(--nav-h);
    ...
    /* Tombol Kembali — warna --bg-yellow sekarang biru muda */
    .nav-kembali {
      width: 186px;
      height: 62px;
      background: var(--bg-yellow);   /* E0F2FE — biru muda */
      border-radius: 30px;
      display: flex;
      align-items: center;
    ...
    .nav-kembali:hover { background: #BAE6FD; transform: translateY(-1px); }
    ...
    /* Lingkaran ikon — #E0F7FA (cyan muda), 71×69 */
    .sidebar-icon-wrap {
      width: 71px;
      height: 69px;
      flex-shrink: 0;
    ...
    /* ═══════════════════════════════════════════
       4 KARTU BAWAH — lingkaran nomor #BAE6FD (sky-200)
    ═══════════════════════════════════════════ */
    .bottom-cards {
      display: grid;
    ...
    /* Lingkaran nomor — #BAE6FD (sky-200) pengganti #C5DE96 */
    .bottom-card-num-wrap {
      ...
      width: 52px;
      height: 50px;
      background: var(--bg-kartu);      /* #BAE6FD */
      border-radius: 9999px;
      border: 1px solid var(--black);
      display: flex;
      align-items: center;
...
<nav>
  <!-- ── ASSET 1: Logo navbar ──
       Tampil: 169 × 60 px | File: ASSET/logo.png -->
...
<div class="page-body">
  ...
  <aside class="sidebar">
    <div class="sidebar-header">
      <!-- ASSET 3 dalam lingkaran — 54×54px | FILE: ASSET/it.png -->
    ...
    <div class="sidebar-list">
      ...
      <a class="sidebar-item <?= $idx === 0 ? 'active' : '' ?>"
        ...
        <!-- ASSET 3: ikon kanan sidebar — 69×69px | FILE: ASSET/it.png -->
  ...
  <main class="content-area">
    ...
    <div class="content-outer">
      ...
      <div class="content-card">
        ...
        <!-- Kolom kanan (accordion) — disembunyikan via CSS, dipakai JS -->
    ...
    <!-- ══════════════════════════════════════════════════════════
         4 KARTU BAWAH
         Lingkaran nomor: #BAE6FD (sky-200) — beda dari BI (#C5DE96)
    ══════════════════════════════════════════════════════════ -->
