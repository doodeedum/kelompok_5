...
if ($session_id > 0) {
    try {
        ...
        error_log("Quiz result3 error: " . $e->getMessage());
    }
}
...
<head>
    ...
    <title>Hasil Quiz Level 3 | TahooGa</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body {
            ...
            /*
            ╔══════════════════════════════════════════════════════╗
            ║  📁 ASSET: Background Halaman Result Level 3        ║
            ║  File: assets/img/bg-result3.png                    ║
...
<div class="card-actions">
    <a href="play3.php?retry=1" class="action-btn">&lt;&lt; Coba Lagi</a>
